---
layout: default
title: HackMore 2025 – Hackathon on Modelling & Rendering
description: Official page for HackMore 2025, the hackathon on 3D modelling and rendering organized by the Italian Chapter of Eurographics.
nav_order: 3
---
...
Congratulations to **Andrea Angelici** and **Alessandro Guillen**, winners of this year’s Hackathon!
...
**Date & Time:**  
**November 26, 2025**, from **8:30 AM to 7:00 PM**

**Location:**  
Bi.Bi. Service  
Via XX Settembre 41  
16121 Genoa (GE), Italy
...
Your goal is to generate the 3D model:

- Using the modeling approach revealed on the day  
- Using a specific interactive modeling software (almost certainly new to you)  
- Optional: procedural generation tools created on site

---

## **For the Programmer / Renderer (P)**

Your goal is to implement a renderer for the teammate’s model:

- Any programming language, algorithm, environment, or libraries allowed
- Two options for producing the video:
  - **Offline:** program outputs numbered frames  
  - **Online:** real‑time screen capture of your program’s output

Restrictions:

- No images, textures, or external assets allowed  
- Only the teammate’s 3D model may be used  
- **No post‑editing** of images or videos
